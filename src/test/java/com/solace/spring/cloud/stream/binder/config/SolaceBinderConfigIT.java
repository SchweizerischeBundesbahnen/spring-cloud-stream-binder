...
public class SolaceBinderConfigIT {
    ...
    void setUp(JCSMPProperties jcsmpProperties, ApplicationContext applicationContext, TestInfo testInfo) throws JCSMPException {
        ...
        jcsmpSessionConfiguration = new JCSMPSessionConfiguration(jcsmpProperties, Optional.empty(), Optional.empty(), Optional.empty());
        binderConfiguration = new SolaceMessageChannelBinderConfiguration(new SolaceExtendedBindingProperties(), jcsmpSessionConfiguration.jcsmpSession(), jcsmpSessionConfiguration.jcsmpContext());
    ...
    public void testClientInfoProvider(JCSMPProperties jcsmpProperties, SempV2Api sempV2Api, SoftAssertions softly) throws Exception {
        ...
        SolaceMessageChannelBinder solaceMessageChannelBinder = binderConfiguration.solaceMessageChannelBinder(jcsmpSessionConfiguration.jcsmpProvisioningProvider(), null, null);
        try {
