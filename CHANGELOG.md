...
### Changed
- Updated swagger-annotations, swagger-core, swagger-models from 2.2.51 to 2.2.52.
...
## [9.0.1] - 2026-04-21
### Changed
- Updated maven-compiler-plugin from 3.14.0 to 3.15.0
...
- Updated examples: testcontainers-solace.version from 2.0.3 to 2.0.4, maven-failsafe-plugin from 3.5.3 to 3.5.5
...
- Fix health indicator must go down when provisioning of any endpoint fails
