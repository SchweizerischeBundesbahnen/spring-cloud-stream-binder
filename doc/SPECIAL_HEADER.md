...
| Constant                                          | Type              | Access   | Default Value                                 | Description                                                                                                                                                                     |
|:--------------------------------------------------|:------------------|:---------|:----------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `SolaceBinderHeaders.PARTITION_KEY`               | `String`          | Read/Write | Unset                                       | The partition key for PubSub+ partitioned queues. Set on producers to route a message to a partition; populated on consumed messages from the Solace `JMSXGroupID` property so applications can read each message's partition key.   |
