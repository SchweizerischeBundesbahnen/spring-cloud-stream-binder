...
class ManualAckIT {
    ...
    @Test
    void messagesAreManuallyAccepted() throws InterruptedException {
        String msg = ManualAckApp.ACCEPTED.poll(30, TimeUnit.SECONDS);
        assertThat(msg).isNotNull().startsWith("msg-");
    }
}
