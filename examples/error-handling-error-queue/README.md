...
Produces a message that will always fail processing.
...
**Inspecting the error queue:** You can view messages on the error queue using the Solace broker's management UI (`http://localhost:8080`) under Queues → `scst/error/wk/error-group/plain/...`.
