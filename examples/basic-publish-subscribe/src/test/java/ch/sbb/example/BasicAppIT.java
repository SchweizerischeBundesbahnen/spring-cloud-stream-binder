...
class BasicAppIT {
    ...
    @Test
    void consumerReceivesMessagesFromSupplier() throws InterruptedException {
        String msg = BasicApp.RECEIVED.poll(30, TimeUnit.SECONDS);
        assertThat(msg).isNotNull().contains("Hello from Solace");
    }
}
