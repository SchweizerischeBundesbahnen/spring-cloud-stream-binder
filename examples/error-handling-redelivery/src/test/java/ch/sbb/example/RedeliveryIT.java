...
class RedeliveryIT {
    ...
    void messageIsRetriedAndEventuallySucceeds() throws InterruptedException {
        ...
        assertThat(RedeliveryApp.SUCCESS_COUNT.get())
            .as("Message should eventually succeed after broker redelivery")
            .isEqualTo(1);
        assertThat(RedeliveryApp.TOTAL_ATTEMPTS.get())
            .as("Local retries should be exhausted before the broker redelivers the message")
            .isGreaterThanOrEqualTo(6);
        assertThat(RedeliveryApp.BROKER_REDELIVERY_COUNT.get())
            .as("At least one broker-level redelivery should occur")
