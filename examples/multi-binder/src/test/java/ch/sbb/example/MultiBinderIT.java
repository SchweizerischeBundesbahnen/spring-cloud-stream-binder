...
class MultiBinderIT {
    ...
    @Test
    void bothBrokersReceiveMessages() throws InterruptedException {
        String msg1 = MultiBinderApp.RECEIVED_1.poll(30, TimeUnit.SECONDS);
        assertThat(msg1).isNotNull().startsWith("msg-to-broker1-");

        String msg2 = MultiBinderApp.RECEIVED_2.poll(30, TimeUnit.SECONDS);
        assertThat(msg2).isNotNull().startsWith("msg-to-broker2-");
    }
}
