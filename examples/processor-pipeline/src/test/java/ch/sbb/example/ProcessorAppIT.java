...
class ProcessorAppIT {
    ...
    @Test
    void processorUppercasesMessages() throws InterruptedException {
        String msg = ProcessorApp.RECEIVED.poll(30, TimeUnit.SECONDS);
        assertThat(msg).isNotNull().isEqualTo("HELLO WORLD");
    }
}
