...
The included test pairs publisher and consumer observations by payload and verifies both that the trace IDs match and that the consumer runs in a different span.
